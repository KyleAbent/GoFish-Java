...
///////////////////////////////////////////////////////////////////////////
 ...
 while(!gameOver)
 {
      ...
      if (gameOver)
      {
        ...
        JOptionPane.showMessageDialog(null,"humanPoints = " + humanPoints + 
...
///////////////////////////////////////////////////////////////////////////
    public static boolean computerInput()
   {
    ...
    System.out.println("\ncomputerPoints = " + 
    computerPoints + ", humanPoints = " + humanPoints);
    ...
    System.out.println("computer chose card #" + numberToScan);
      ...
      else{ if (!match && !isZero && !getisDeckDealerEmpty()) 
      {handComputer.addCard(handHuman, handComputer, deckDealer);} 
      turnCounter = turnCounter + 1; humanTurn = true;computerTurn = false;}
     ...
     if (difficulty >= tunedNumber) 
      {
          ...
          int tries = 0;
          while(!plucked && tries <= handHuman.getHand().size())
          {
          int idx = random.nextInt(handHuman.getHand().size());
          int humanCard = (int)handHuman.getHand().get(idx);
          boolean computerHas = handComputer.getHand().contains(humanCard);
           if (computerHas){plucked = true; setScanNumber(humanCard);}
           tries += 1;
          }
     }
       else
...
///////////////////////////////////////////////////////////////////////////  
  ...
  public static boolean getIsHumanCheating()
  {
   ...
   if (cheating) {JOptionPane.showMessageDialog(null,"You are cheating. You do not own card # " + 
   numberToScan + "! Try Again!");  }
   return cheating;
  }
